public class Main
{
    ...
    static String fixStart(String s)
    {
        ...
        String text = s.replace(s.charAt(0),'*');
    ...
    {
        String first_2_a = a.substring(0,2);
        String first_2_b = b.substring(0,2);
        return first_2_b+a.substring(2) + " " + first_2_a + b.substring(2);
    }
